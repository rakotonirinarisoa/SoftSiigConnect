    ...
    public class TraitementJustifController : Controller
    {
                ...
                if (tom.CPTADMIN_FAVANCE.Any(a => site.Contains(a.SITE)))
                {
                    foreach (var x in tom.CPTADMIN_FAVANCE.Where(a => site.Contains(a.SITE)).OrderBy(a => a.DATEAVANCE).ToList())
                    {
                        ...
                        if (Math.Round(MTN, 3) == Math.Round(MTNPJ, 3))
                        {
                            ...
                            if (canBe)
                            {
                                if (tom.GA_AVANCE_JUSTIFICATIF.Any(a => a.NUMERO_AVANCE == x.NUMEROAVANCE && site.Contains(a.SITE)))
                                {
                                    foreach (var y in tom.GA_AVANCE_JUSTIFICATIF.Where(a => a.NUMERO_AVANCE == x.NUMEROAVANCE && site.Contains(a.SITE)).OrderBy(a => a.DATE).OrderBy(a => a.NUMERO_PIECE).ToList())
                                    {
                                        Guid idJustif = Guid.Parse(y.ID);
                                        if (!db.SI_TRAITJUSTIF.Any(a => a.No == idJustif && a.NPIECE == y.NUMERO_PIECE && a.IDPROJET == crpt && site.Contains(a.SITE)) || db.SI_TRAITJUSTIF.Any(a => a.No == idJustif && a.ETAT == 2 && a.IDPROJET == crpt && site.Contains(a.SITE)))
                                        {
                                            var titulaire = "";
                ...
                if (tom.CPTADMIN_FAVANCE.Any(a => site.Contains(a.SITE)))
                {
                    foreach (var x in tom.CPTADMIN_FAVANCE.Where(a => site.Contains(a.SITE)).OrderBy(a => a.DATEAVANCE).ToList())
                    {
                        ...
                        if (Math.Round(MTN, 3) == Math.Round(MTNPJ, 3))
                        {
                            ...
                            if (canBe)
                            {
                                if (tom.GA_AVANCE_JUSTIFICATIF.Any(a => a.NUMERO_AVANCE == x.NUMEROAVANCE && a.DATE >= DateDebut && a.DATE <= DateFin && site.Contains(a.SITE)))
                                {
                                    ...
                                    {
                                        Guid idJustif = Guid.Parse(y.ID);
                                        if (!db.SI_TRAITJUSTIF.Any(a => a.No == idJustif && a.NPIECE == y.NUMERO_PIECE && a.IDPROJET == crpt && site.Contains(a.SITE)) || db.SI_TRAITJUSTIF.Any(a => a.No == idJustif && a.NPIECE == y.NUMERO_PIECE && a.ETAT == 2 && a.IDPROJET == crpt && site.Contains(a.SITE)))
                                        {
                                            var titulaire = "";
        ...
        public JsonResult GetCheckedEcritureF(SI_USERS suser, string listCompte, int iProjet)
        {
            ...
            foreach (var SAV in listCompteS)
            {
                try
                {
                    ...
                    var isPiece = tom.GA_AVANCE_JUSTIFICATIF.FirstOrDefault(a => a.ID == SAV && site.Contains(a.SITE));
                    if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == elem && a.NPIECE == isPiece.NUMERO_PIECE && a.ETAT == 2 && a.IDPROJET == crpt && site.Contains(a.SITE)) != null)
                    {
                        var ismod = db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == elem && a.NPIECE == isPiece.NUMERO_PIECE && a.IDPROJET == crpt && site.Contains(a.SITE));
                        ismod.ETAT = 0;
            ...
            using (System.Net.Mail.MailMessage mail = new System.Net.Mail.MailMessage())
            {
                ...
                if (db.SI_MAIL.FirstOrDefault(a => a.IDPROJET == crpt && a.DELETIONDATE == null && site.Contains(a.SITE)).MAILJ0 != null)
                {
                    string[] separators = { ";" };
                    ...
                    if (Tomail != null)
                    {
                        string listUser = db.SI_MAIL.FirstOrDefault(a => a.IDPROJET == crpt && a.DELETIONDATE == null && site.Contains(a.SITE)).MAILJ0;
        ...
        public async Task<JsonResult> ModalD(SI_USERS suser, string IdF, int iProjet)
        {
            ...
            try
            {
                ...
                if (tom.GA_AVANCE_JUSTIFICATIF.FirstOrDefault(a => a.ID == IdF && site.Contains(a.SITE)) != null)
                {
                    foreach (var x in tom.GA_AVANCE_JUSTIFICATIF.Where(a => a.ID == IdF && site.Contains(a.SITE)).ToList())
                    {
        ...
        public async Task<JsonResult> ModalLIAS(SI_USERS suser, string IdF, int iProjet)
        {
            ...
            try
            {
                ...
                var isJustif = tom.GA_AVANCE_JUSTIFICATIF.FirstOrDefault(a => a.ID == IdF && site.Contains(a.SITE));
        ...
        public async Task<JsonResult> ModalF(SI_USERS suser, string IdF, int iProjet)
        {
            ...
            try
            {
                ...
                if (tom.GA_AVANCE_JUSTIFICATIF.Any(a => a.ID == IdF && site.Contains(a.SITE)))
                {
                    list.Add(new DATATRPROJET
                    {
                        LIEN = tom.GA_AVANCE_JUSTIFICATIF.FirstOrDefault(a => a.ID == IdF && site.Contains(a.SITE)).COMMENTAIRE != null ? tom.GA_AVANCE_JUSTIFICATIF.FirstOrDefault(a => a.ID == IdF && site.Contains(a.SITE)).COMMENTAIRE : ""
                    });
                }
        ...
        public JsonResult AnnulationJustif(SI_USERS suser, Guid IdF, string Comm, string Motif, int iProjet)
        {
            ...
            try
            {
                ...
                if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == IdF && a.IDPROJET == IdS && site.Contains(a.SITE)) != null)
                {
                    var ismod = db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == IdF && a.IDPROJET == IdS && site.Contains(a.SITE));
                    ismod.ETAT = 2;
                    //ismod.DATECRE = DateTime.Now;
                ...
                using (System.Net.Mail.MailMessage mail = new System.Net.Mail.MailMessage())
                {
                    ...
                    mail.To.Add(MailAdresse);
                    if (db.SI_MAIL.FirstOrDefault(a => a.IDPROJET == IdS && a.DELETIONDATE == null && site.Contains(a.SITE)).MAILREJETJUST != null)
                    {
                        string[] separators = { ";" };
                        ...
                        if (Tomail != null)
                        {
                            string listUser = db.SI_MAIL.FirstOrDefault(a => a.IDPROJET == IdS && a.DELETIONDATE == null && site.Contains(a.SITE)).MAILREJETJUST;
                            string[] mailListe = listUser.Split(separators, StringSplitOptions.RemoveEmptyEntries);
        ...
        public JsonResult GenerationSIIGLOAD(SI_USERS suser, int iProjet)
        {
            ...
            try
            {
                ...
                if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.IDPROJET == crpt && a.ETAT == 0 && site.Contains(a.SITE)) != null)
                {
                    foreach (var x in db.SI_TRAITJUSTIF.Where(a => a.IDPROJET == crpt && a.ETAT == 0 && site.Contains(a.SITE)).OrderBy(a => a.DATECRE).OrderBy(a => a.DATEMANDAT).ToList())
                    {
                        var soa = (from soas in db.SI_SOAS
                                   join prj in db.SI_PROSOA on soas.ID equals prj.IDSOA
                                   where prj.IDPROJET == crpt && prj.DELETIONDATE == null && soas.DELETIONDATE == null
        ...
        public JsonResult GenerationSIIG(SI_USERS suser, DateTime DateDebut, DateTime DateFin, int iProjet)
        {
            ...
            try
            {
                ...
                if (db.SI_TRAITJUSTIF.Any(a => a.IDPROJET == crpt && a.DATEMANDAT >= DateDebut && a.DATEMANDAT <= DateFin && a.ETAT == 0 && site.Contains(a.SITE)))
                {
                    foreach (var x in db.SI_TRAITJUSTIF.Where(a => a.IDPROJET == crpt && a.DATEMANDAT >= DateDebut && a.DATEMANDAT <= DateFin && a.ETAT == 0 && site.Contains(a.SITE)).OrderBy(a => a.DATECRE).OrderBy(a => a.DATEMANDAT).ToList())
                    {
                        var soa = (from soas in db.SI_SOAS
                                   join prj in db.SI_PROSOA on soas.ID equals prj.IDSOA
                                   where prj.IDPROJET == crpt && prj.DELETIONDATE == null && soas.DELETIONDATE == null
        ...
        public JsonResult GetCheckedEcritureORDSEC(SI_USERS suser, string listCompte, int iProjet)
        {
            ...
            foreach (var SAV in listCompteS)
            {
                try
                {
                    ...
                    if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.IDPROJET == crpt && a.No == isSAV && site.Contains(a.SITE)) != null)
                    {
                        var isModified = db.SI_TRAITJUSTIF.FirstOrDefault(a => a.IDPROJET == crpt && a.No == isSAV && site.Contains(a.SITE));
                        isModified.ETAT = 1;
            ...
            using (System.Net.Mail.MailMessage mail = new System.Net.Mail.MailMessage())
            {
                ...
                mail.To.Add(MailAdresse);
                if (db.SI_MAIL.FirstOrDefault(a => a.IDPROJET == crpt && a.DELETIONDATE == null && site.Contains(a.SITE)).MAILJ1 != null)
                {
                    string[] separators = { ";" };
                    ...
                    if (Tomail != null)
                    {
                        string listUser = db.SI_MAIL.FirstOrDefault(a => a.IDPROJET == crpt && a.DELETIONDATE == null && site.Contains(a.SITE)).MAILJ1;
                        string[] mailListe = listUser.Split(separators, StringSplitOptions.RemoveEmptyEntries);
