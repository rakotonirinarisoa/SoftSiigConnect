            ...
            foreach (var item in siteS.Split(','))
            {
                ...
                foreach (var SAV in listCompteS)
                {
                    try
                    {
                        ...
                        var isPiece = tom.GA_AVANCE_JUSTIFICATIF.FirstOrDefault(a => a.ID == SAV && a.SITE == item);
                        if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == elem && a.NPIECE == isPiece.NUMERO_PIECE && a.ETAT == 2 && a.IDPROJET == crpt && a.SITE == item) != null)
                        {
                            var ismod = db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == elem && a.NPIECE == isPiece.NUMERO_PIECE && a.IDPROJET == crpt && a.SITE == item);
                            ismod.ETAT = 0;
                        ...
                        {
                            var titulaire = "";
                            var isGA = tom.GA_AVANCE.FirstOrDefault(a => a.NUMERO == isPiece.NUMERO_AVANCE && a.SITE == item);
                            if (isGA != null)
                            {
                                if (tom.GA_AVANCE.FirstOrDefault(a => a.NUMERO == isPiece.NUMERO_AVANCE && a.SITE == item).COGE != null && tom.GA_AVANCE.FirstOrDefault(a => a.NUMERO == isPiece.NUMERO_AVANCE && a.SITE == item).AUXI != null)
                                {
                                    if (tom.RTIERS.Any(a => a.COGE == isGA.COGE && a.AUXI == isGA.AUXI))
                                        titulaire = tom.RTIERS.FirstOrDefault(a => a.COGE == isGA.COGE && a.AUXI == isGA.AUXI).NOM;
                                }
        ...
        public JsonResult AnnulationJustif(SI_USERS suser, Guid IdF, string Comm, string Motif, int iProjet)
        {
            ...
            try
            {
                ...
                foreach (var item in siteS.Split(','))
                {
                    ...
                    if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == IdF && a.IDPROJET == IdS && a.SITE == item) != null)
                    {
                        var ismod = db.SI_TRAITJUSTIF.FirstOrDefault(a => a.No == IdF && a.IDPROJET == IdS && a.SITE == item);
                        ismod.ETAT = 2;
                        //ismod.DATECRE = DateTime.Now;
            ...
            foreach (var item in siteS.Split(','))
            {
                ...
                foreach (var SAV in listCompteS)
                {
                    try
                    {
                        ...
                        if (db.SI_TRAITJUSTIF.FirstOrDefault(a => a.IDPROJET == crpt && a.No == isSAV && a.SITE == item) != null)
                        {
                            var isModified = db.SI_TRAITJUSTIF.FirstOrDefault(a => a.IDPROJET == crpt && a.No == isSAV && a.SITE == item);
                            isModified.ETAT = 1;
