        ...
        success: function (result) {
            ...
            $.each(ListResultBr, function (k, v) {
                data.push({
                    COMPTEG: v.COMPTEG,
                    AUXI: v.AUXI,
                    COMPTE_BANQUE: v.COMPTE_BANQUE,
                    Journal: v.JOURNAL,
                    DOM1: v.DOM1,
                    AD1: v.AD1,
                    RIB: v.RIB,
                    TYPE: v.TYPE,
                    IDPROJECT: v.IDPROJECT,
                });
            });
            if (table !== undefined) {
                table.destroy();
            ...
            table = $('#idTable').DataTable({
                ...
                buttons: ['colvis',
                    {
                        extend: 'pdfHtml5',
                        title: 'ANOMALIE DE REGLEMENTS',
                        messageTop: 'Liste des anomalies des paiements',
            ...
            $('#historiques tfoot th').each(function (i) {
                //if (i == 0) {
