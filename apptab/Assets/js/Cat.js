...
function GetUsers(id) {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/Parametre/DetailsCat',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$(`[data-action="UpdateUser"]`).click(function () {
    ...
    let code = $("#Code").val();
    if (!user || !code) {
        alert("Veuillez renseigner l'information sur la catégorie. ");
        return;
    }
    ...
    formData.append("param.CATEGORIE", $(`#Para`).val());
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/Parametre/UpdateCat',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
