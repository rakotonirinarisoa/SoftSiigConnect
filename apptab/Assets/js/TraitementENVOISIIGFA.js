...
function GetListLOAD() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GenerationSIIGLOADSEND',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_ORDSEC').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'AVANCES A TRANSFERER SIIGFP',
                            messageTop: 'Liste des avances en attente transfert SIIGFP',
...
$('[data-action="GenereSIIG"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GenerationSIIGENVOI',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$('[data-action="SaveSIIG"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GetCheckedEcritureORDSECSEND',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
