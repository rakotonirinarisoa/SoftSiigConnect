...
$('[data-action="GenereLISTE"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/BordTraitement/GenereStatutJR',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_ORDSEC').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'JUSTIFICATIFS, REVERSEMENTS et COMPLEMENTS',
                            messageTop: 'Liste des justificatifs, des reversements et des compléments',
