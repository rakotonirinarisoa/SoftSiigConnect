...
function GetListLOAD() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementComplement/GenerationSIIGLOAD',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_ORDSEC').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'COMPLEMENTS A VALIDER',
                            messageTop: 'Liste des compléments en attente validation',
...
$('[data-action="GenereSIIG"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementComplement/GenerationSIIG',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$('[data-action="SaveSIIG"]').click(function () {
    ...
    if (list.length == 0) {
        alert("Veuillez sélectionner au moins un complément afin de le valider. ");
        return;
    }
...
function OKOK() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementComplement/GetCheckedEcritureORDSEC',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
