...
function GetListProjet() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/Anomalie/GetAllPROJET',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$('[data-action="GenereR"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/Anomalie/GenereLISTE',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_MANDAT').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'ANOMALIE DEPENSES A PAYER ET AVANCES',
                            messageTop: 'Liste anomalie générale des dépenses à payer et avances',
