...
function GetUsers() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/Parametre/DetailsTypeBanque',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function (result) {
            ...
            $(`input[data-id="${Datas.data.BtnVirement}"]`).click();
...
$(`[data-action="UpdateUser"]`).click(function () {
    ...
    formData.append("param.BtnVirement", $("input[name='BtnVirement']:checked").attr("data-id"));

    formData.append("iProjet", $("#proj").val());

    $.ajax({
        type: "POST",
        url: Origin + '/Parametre/UpdateTypeBanque',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
