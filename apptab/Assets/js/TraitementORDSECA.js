...
function GetListLOAD() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GenerationSIIGLOAD',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_ORDSEC').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'AVANCES A VALIDER',
                            messageTop: 'Liste des avances en attente validation',
...
$('[data-action="GenereSIIG"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GenerationSIIG',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$('[data-action="SaveV"]').click(function () {
    ...
    if (list.length == 0) {
        alert("Veuillez sélectionner au moins une avance afin de la valider. ");
        return;
    }
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GetCheckedEcritureF',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
function OKOK() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementAvance/GetCheckedEcritureORDSEC',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
