...
function GetListLOADOTHER() {
    ...
    $.ajax({
        type: "POST",
        async: true,
        url: Origin + '/TraitementRevers/GenerationLOAD',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_MANDAT').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'REVERSEMENTS A ENVOYER POUR VALIDATION',
                            messageTop: 'Liste des reversements en attente envoi pour validation',
...
$('[data-action="GenereR"]').click(async function () {
    ...
    $.ajax({
        type: "POST",
        async: true,
        url: Origin + '/TraitementRevers/Generation',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
