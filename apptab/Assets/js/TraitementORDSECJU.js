...
function GetListProjet() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementJustif/GetAllPROJET',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
function GetListLOAD() {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementJustif/GenerationSIIGLOAD',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
            ...
            if (Datas.type == "success") {
                ...
                table = $('#TBD_PROJET_ORDSEC').DataTable({
                    ...
                    buttons: ['colvis',
                        {
                            extend: 'pdfHtml5',
                            title: 'JUSTIFICATIFS A VALIDER',
                            messageTop: 'Liste des justificatifs en attente validation',
...
$('[data-action="GenereSIIG"]').click(function () {
    ...
    let df = $("#dateF").val();
    if (!dd || !df) {
        alert("Veuillez renseigner les dates afin de générer les justificatifs. ");
        return;
    }
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementJustif/GenerationSIIG',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$('[data-action="SaveV"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementJustif/GetCheckedEcritureF',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$('[data-action="SaveSIIG"]').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: Origin + '/TraitementJustif/GetCheckedEcritureORDSEC',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
