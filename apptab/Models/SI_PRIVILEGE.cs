namespace apptab
{
    ...
    public partial class SI_PRIVILEGE
    {
        ...
        public int? TDB1GED { get; set; }
        public int? TDB2GED { get; set; }
        public int? TDB3GED { get; set; }
        public int? TDB4GED { get; set; }
        public int? TDB5GED { get; set; }
        public int? TDB6GED { get; set; }
